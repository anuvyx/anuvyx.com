(() => {
    ...
    const loadChatHistory = () => {
      ...
      // Delegación de eventos para cargar el chat al hacer clic
    ...
    const showChatOptions = (chatId) => {
      const button = document.querySelector(
        `.chat-item[data-id="${chatId}"] .chat-options-btn`
      );
  
      // Si ya hay un menú abierto en ese chat, se cierra
    ...
    const showLoadingWithCounter = () => {
      ...
      // Elemento spinner (se recomienda mover estos estilos al CSS)
